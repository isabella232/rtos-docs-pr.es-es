...
#### <a name="module-preamble-for-arm11-using-gcc"></a>Preámbulo de módulo para ARM11 con GCC
...
#### <a name="module-properties-for-arm11-using-gcc"></a>Propiedades de módulo para ARM11 con GCC
...
#### <a name="building-modules-for-arm11-using-gcc"></a>Compilación de módulos para ARM11 con GCC

Ejemplo sencillo de línea de comandos para compilar un módulo de ARM11 con GCC:
...
#### <a name="thread-extension-definition-for-arm11-using-gcc"></a>Definición de extensión de subproceso para ARM11 con GCC
...
#### <a name="building-module-manager-for-arm11-using-gcc"></a>Compilación de administrador de módulos para ARM11 con GCC

No se proporciona ningún ejemplo.

#### <a name="attributes-for-external-memory-enable-api-for-arm11-using-gcc"></a>Atributos de API de habilitación de memoria externa para ARM11 con GCC

Esta característica no está habilitada en esta distribución.

### <a name="arm11-using-ac5"></a>ARM11 con AC5

#### <a name="module-preamble-for-arm11-using-ac5"></a>Preámbulo de módulo para ARM11 con AC5
...
#### <a name="module-properties-for-arm11-using-ac5"></a>Propiedades de módulo para ARM11 con AC5
...
Se compila en la línea de comandos; no hay ningún ejemplo de archivo de enlazador.

#### <a name="building-modules-for-arm11-using-ac5"></a>Compilación de módulos para ARM11 con AC5

Ejemplo sencillo de línea de comandos para compilar un módulo de ARM11 con AC5:
...
#### <a name="thread-extension-definition-for-arm11-using-ac5"></a>Definición de extensión de subproceso para ARM11 con AC5
...
#### <a name="building-module-manager-for-arm11-using-ac5"></a>Compilación de administrador de módulos para ARM11 con AC5

Ejemplo sencillo de línea de comandos para compilar un administrador de módulos de ARM11 con AC5:
...
#### <a name="attributes-for-external-memory-enable-api-for-arm11-using-ac5"></a>Atributos de API de habilitación de memoria externa para ARM11 con AC5

Esta característica no está habilitada en esta distribución.

## <a name="cortex-a7-processor"></a>Procesador Cortex-A7

### <a name="cortex-a7-using-ac5"></a>Cortex-A7 con AC5

#### <a name="module-preamble-for-cortex-a7-using-ac5"></a>Preámbulo de módulo para Cortex-A7 con AC5
...
#### <a name="module-properties-for-cortex-a7-using-ac5"></a>Propiedades de módulo para Cortex-A7 con AC5
...
#### <a name="building-modules-for-cortex-a7-using-ac5"></a>Compilación de módulos para Cortex-A7 con AC5

Ejemplo sencillo de línea de comandos para compilar un módulo de Cortex-A7 con AC5:
...
#### <a name="thread-extension-definition-for-cortex-a7-using-ac5"></a>Definición de extensión de subproceso para Cortex-A7 con AC5
...
#### <a name="building-module-manager-for-cortex-a7-using-ac5"></a>Compilación de administrador de módulos para Cortex-A7 con AC5

Ejemplo sencillo de línea de comandos para compilar un administrador de módulos de Cortex-A7 con AC5:
...
| TXM_MMU_ATTRIBUTE_B | Valor B |
| TXM_MMU_ATTRIBUTE_C | Valor C |
| TXM_MMU_ATTRIBUTE_AP | Valor AP |
| TXM_MMU_ATTRIBUTE_TEX | Valor TEX |

Consulte la documentación de ARM para ver cómo se configuran estos valores.

## <a name="cortex-m3-processor"></a>Procesador Cortex-M3

### <a name="cortex-m3-using-ac5"></a>Cortex-M3 con AC5

#### <a name="module-preamble-for-cortex-m3-using-ac5"></a>Preámbulo de módulo para Cortex-M3 con AC5
...
#### <a name="module-properties-for-cortex-m3-using-ac5"></a>Propiedades de módulo para Cortex-M3 con AC5
...
No se proporciona ningún archivo de enlazador de ejemplo; el enlace se realiza en la línea de comandos. Consulte la siguiente sección.

#### <a name="building-modules-for-cortex-m3-using-ac5"></a>Compilación de módulos para Cortex-M3 con AC5

A continuación se muestra un script de compilación de ejemplo:
...
#### <a name="thread-extension-definition-for-cortex-m3-using-ac5"></a>Definición de extensión de subproceso para Cortex-M3 con AC5
...
#### <a name="building-module-manager-for-cortex-m3-using-ac5"></a>Compilación de administrador de módulos para Cortex-M3 con AC5

Consulte el archivo build_threadx_module_manager_demo.bat de ejemplo:
...
#### <a name="module-preamble-for-cortex-m3-using-ac6"></a>Preámbulo de módulo para Cortex-M3 con AC6
...
#### <a name="module-properties-for-cortex-m3-using-ac6"></a>Propiedades de módulo para Cortex-M3 con AC6
...
No se usa ningún archivo de enlazador. Consulte la configuración del proyecto.

#### <a name="building-modules-for-cortex-m3-using-ac6"></a>Compilación de módulos para Cortex-M3 con AC6

Se proporciona un área de trabajo de ejemplo. Compile la biblioteca de ThreadX, la biblioteca de ThreadX Modules, el proyecto de módulo de muestra y el proyecto de administrador de módulos de muestra.

#### <a name="thread-extension-definition-for-cortex-m3-using-ac6"></a>Definición de extensión de subproceso para Cortex-M3 con AC6
...
#### <a name="building-module-manager-for-cortex-m3-using-ac6"></a>Compilación de administrador de módulos para Cortex-M3 con AC6
...
#### <a name="module-preamble-for-cortex-m3-using-gnu"></a>Preámbulo de módulo para Cortex-M3 con GNU
...
#### <a name="module-properties-for-cortex-m3-using-gnu"></a>Propiedades de módulo para Cortex-M3 con GNU
...
#### <a name="building-modules-for-cortex-m3-using-gnu"></a>Compilación de módulos para Cortex-M3 con GNU

Consulte el archivo build_threadx_module_sample.bat:
...
#### <a name="thread-extension-definition-for-cortex-m3-using-gnu"></a>Definición de extensión de subproceso para Cortex-M3 con GNU
...
#### <a name="building-module-manager-for-cortex-m3-using-gnu"></a>Compilación de administrador de módulos para Cortex-M3 con GNU

Consulte el archivo build_threadx_module_manager_sample.bat:
...
#### <a name="module-preamble-for-cortex-m3-using-iar"></a>Preámbulo de módulo para Cortex-M3 con IAR
...
#### <a name="module-properties-for-cortex-m3-using-iar"></a>Propiedades de módulo para Cortex-M3 con IAR
...
#### <a name="building-modules-for-cortex-m3-using-iar"></a>Compilación de módulos para Cortex-M3 con IAR

Se proporciona un área de trabajo de ejemplo. Compile la biblioteca de ThreadX, la biblioteca de ThreadX Modules, el proyecto de módulo de demostración y el proyecto de administrador de módulos de demostración.

#### <a name="thread-extension-definition-for-cortex-m3-using-iar"></a>Definición de extensión de subproceso para Cortex-M3 con IAR
...
#### <a name="building-module-manager-for-cortex-m3-using-iar"></a>Compilación de administrador de módulos para Cortex-M3 con IAR
...
## <a name="cortex-m33-processor"></a>Procesador Cortex-M33

### <a name="cortex-m33-using-ac6"></a>Cortex-M33 con AC6

#### <a name="module-preamble-for-cortex-m33-using-ac6"></a>Preámbulo de módulo para Cortex-M33 con AC6
...
#### <a name="module-properties-for-cortex-m33-using-ac6"></a>Propiedades de módulo para Cortex-M33 con AC6
...
No se necesita ningún archivo de enlazador para la cadena de herramientas Keil. Consulte la configuración de compilación en el proyecto de ejemplo.
A continuación se enumeran opciones importantes del enlazador:

```c
--entry demo_module_start --first __txm_module_preamble
```

#### <a name="building-modules-for-cortex-m33-using-ac6"></a>Compilación de módulos para Cortex-M33 con AC6
...
#### <a name="thread-extension-definition-for-cortex-m33-using-ac6"></a>Definición de extensión de subproceso para Cortex-M33 con AC6
...
#### <a name="building-module-manager-for-cortex-m33-using-ac6"></a>Compilación de administrador de módulos para Cortex-M33 con AC6

Se proporciona un área de trabajo de ejemplo. Compile la biblioteca de ThreadX, la biblioteca de ThreadX Modules y los proyectos sample_threadx_module y demo_threadx_non-secure_zone.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-ac6"></a>Atributos de API de habilitación de memoria externa para Cortex-M33 con AC6
...
#### <a name="module-preamble-for-cortex-m33-using-gnu"></a>Preámbulo de módulo para Cortex-M33 con GNU

#### <a name="module-properties-for-cortex-m33-using-gnu"></a>Propiedades de módulo para Cortex-M33 con GNU
...
#### <a name="building-modules-for-cortex-m33-using-gnu"></a>Compilación de módulos para Cortex-M33 con GNU

#### <a name="thread-extension-definition-for-cortex-m33-using-gnu"></a>Definición de extensión de subproceso para Cortex-M33 con GNU

#### <a name="building-module-manager-for-cortex-m33-using-gnu"></a>Compilación de administrador de módulos para Cortex-M33 con GNU

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-gnu"></a>Atributos de API de habilitación de memoria externa para Cortex-M33 con GNU
...
#### <a name="module-preamble-for-cortex-m33-using-iar"></a>Preámbulo de módulo para Cortex-M33 con IAR
...
#### <a name="module-properties-for-cortex-m33-using-iar"></a>Propiedades de módulo para Cortex-M33 con IAR
...
#### <a name="building-modules-for-cortex-m33-using-iar"></a>Compilación de módulos para Cortex-M33 con IAR

#### <a name="thread-extension-definition-for-cortex-m33-using-iar"></a>Definición de extensión de subproceso para Cortex-M33 con IAR
...
#### <a name="building-module-manager-for-cortex-m33-using-iar"></a>Compilación de administrador de módulos para Cortex-M33 con IAR

Todavía no se ha proporcionado ningún área de trabajo de ejemplo. Próximamente.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-iar"></a>Atributos de API de habilitación de memoria externa para Cortex-M33 con IAR
...
## <a name="cortex-m4-processor"></a>Procesador Cortex-M4

### <a name="cortex-m4-using-ac5"></a>Cortex-M4 con AC5

#### <a name="module-preamble-for-cortex-m4-using-ac5"></a>Preámbulo de módulo para Cortex-M4 con AC5
...
#### <a name="module-properties-for-cortex-m4-using-ac5"></a>Propiedades de módulo para Cortex-M4 con AC5
...
#### <a name="building-modules-for-cortex-m4-using-ac5"></a>Compilación de módulos para Cortex-M4 con AC5

Consulte el archivo build_threadx_module_demo.bat de ejemplo:
...
#### <a name="thread-extension-definition-for-cortex-m4-using-ac5"></a>Definición de extensión de subproceso para Cortex-M4 con AC5
...
#### <a name="building-module-manager-for-cortex-m4-using-ac5"></a>Compilación de administrador de módulos para Cortex-M4 con AC5
...
#### <a name="module-preamble-for-cortex-m4-using-ac6"></a>Preámbulo de módulo para Cortex-M4 con AC6
...
#### <a name="module-properties-for-cortex-m4-using-ac6"></a>Propiedades de módulo para Cortex-M4 con AC6
...
#### <a name="building-modules-for-cortex-m4-using-ac6"></a>Compilación de módulos para Cortex-M4 con AC6

Se proporciona un área de trabajo de ejemplo. Compile la biblioteca de ThreadX, la biblioteca de ThreadX Modules, el proyecto de módulo de muestra y el proyecto de administrador de módulos de muestra.

#### <a name="thread-extension-definition-for-cortex-m4-using-ac6"></a>Definición de extensión de subproceso para Cortex-M4 con AC6
...
#### <a name="building-module-manager-for-cortex-m4-using-ac6"></a>Compilación de administrador de módulos para Cortex-M4 con AC6
...
#### <a name="module-preamble-for-cortex-m4-using-gnu"></a>Preámbulo de módulo para Cortex-M4 con GNU
...
#### <a name="module-properties-for-cortex-m4-using-gnu"></a>Propiedades de módulo para Cortex-M4 con GNU
...
#### <a name="building-modules-for-cortex-m4-using-gnu"></a>Compilación de módulos para Cortex-M4 con GNU
...
#### <a name="thread-extension-definition-for-cortex-m4-using-gnu"></a>Definición de extensión de subproceso para Cortex-M4 con GNU
...
#### <a name="building-module-manager-for-cortex-m4-using-gnu"></a>Compilación de administrador de módulos para Cortex-M4 con GNU
...
#### <a name="module-preamble-for-cortex-m4-using-iar"></a>Preámbulo de módulo para Cortex-M4 con IAR
...
#### <a name="module-properties-for-cortex-m4-using-iar"></a>Propiedades de módulo para Cortex-M4 con IAR
...
#### <a name="building-modules-for-cortex-m4-using-iar"></a>Compilación de módulos para Cortex-M4 con IAR

Se proporciona un área de trabajo de ejemplo. Compile la biblioteca de ThreadX, la biblioteca de ThreadX Modules, el proyecto de módulo de demostración y el proyecto de administrador de módulos de demostración.

#### <a name="thread-extension-definition-for-cortex-m4-using-iar"></a>Definición de extensión de subproceso para Cortex-M4 con IAR
...
#### <a name="building-module-manager-for-cortex-m4-using-iar"></a>Compilación de administrador de módulos para Cortex-M4 con IAR
...
## <a name="cortex-m7-processor"></a>Procesador Cortex-M7

### <a name="cortex-m7-using-ac5"></a>Cortex-M7 con AC5

#### <a name="module-preamble-for-cortex-m7-using-ac5"></a>Preámbulo de módulo para Cortex-M7 con AC5
...
#### <a name="module-properties-for-cortex-m7-using-ac5"></a>Propiedades de módulo para Cortex-M7 con AC5
...
#### <a name="building-modules-for-cortex-m7-using-ac5"></a>Compilación de módulos para Cortex-M7 con AC5

Ejemplo sencillo de línea de comandos para compilar un módulo de Cortex-M7 con AC5:
...
#### <a name="thread-extension-definition-for-cortex-m7-using-ac5"></a>Definición de extensión de subproceso para Cortex-M7 con AC5
...
#### <a name="building-module-manager-for-cortex-m7-using-ac5"></a>Compilación de administrador de módulos para Cortex-M7 con AC5

Ejemplo sencillo de línea de comandos para compilar un administrador de módulos de Cortex-M7 con AC5:
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m7-using-ac5"></a>Atributos de API de habilitación de memoria externa para Cortex-M7 con AC5

### <a name="cortex-m7-using-ac6"></a>Cortex-M7 con AC6

#### <a name="module-properties-for-cortex-m7-using-ac6"></a>Propiedades de módulo para Cortex-M7 con AC6
...
#### <a name="building-modules-for-cortex-m7-using-ac6"></a>Compilación de módulos para Cortex-M7 con AC6

Se proporciona un área de trabajo de ejemplo. Compile la biblioteca de ThreadX, la biblioteca de ThreadX Modules, el proyecto de módulo de muestra y el proyecto de administrador de módulos de muestra.

#### <a name="thread-extension-definition-for-cortex-m7-using-ac6"></a>Definición de extensión de subproceso para Cortex-M7 con AC6
...
#### <a name="building-module-manager-for-cortex-m7-using-ac6"></a>Compilación de administrador de módulos para Cortex-M7 con AC6
...
#### <a name="module-properties-for-cortex-m7-using-gnu"></a>Propiedades de módulo para Cortex-M7 con GNU
...
#### <a name="building-modules-for-cortex-m7-using-gnu"></a>Compilación de módulos para Cortex-M7 con GNU
...
#### <a name="thread-extension-definition-for-cortex-m7-using-gnu"></a>Definición de extensión de subproceso para Cortex-M7 con GNU
...
#### <a name="building-module-manager-for-cortex-m7-using-gnu"></a>Compilación de administrador de módulos para Cortex-M7 con GNU
...
#### <a name="module-preamble-for-cortex-m7-using-iar"></a>Preámbulo de módulo para Cortex-M7 con IAR
...
#### <a name="module-properties-for-cortex-m7-using-iar"></a>Propiedades de módulo para Cortex-M7 con IAR
...
#### <a name="building-modules-for-cortex-m7-using-iar"></a>Compilación de módulos para Cortex-M7 con IAR

Se proporciona un área de trabajo de ejemplo. Compile la biblioteca de ThreadX, la biblioteca de ThreadX Modules, el proyecto de módulo de demostración y el proyecto de administrador de módulos de demostración.

#### <a name="thread-extension-definition-for-cortex-m7-using-iar"></a>Definición de extensión de subproceso para Cortex-M7 con IAR
...
#### <a name="building-module-manager-for-cortex-m7-using-iar"></a>Compilación de administrador de módulos para Cortex-M7 con IAR
...
## <a name="cortex-r4-processor"></a>Procesador Cortex-R4

### <a name="cortex-r4-using-ac6"></a>Cortex-R4 con AC6

#### <a name="module-preamble-for-cortex-r4-using-ac6"></a>Preámbulo de módulo para Cortex-R4 con AC6
...
#### <a name="module-properties-for-cortex-r4-using-ac6"></a>Propiedades de módulo para Cortex-R4 con AC6
...
#### <a name="building-modules-for-cortex-r4-using-ac6"></a>Compilación de módulos para Cortex-R4 con AC6

Ejemplo sencillo de línea de comandos para compilar un módulo de Cortex-R4 con AC6:
...
#### <a name="thread-extension-definition-for-cortex-r4-using-ac6"></a>Definición de extensión de subproceso para Cortex-R4 con AC6
...
#### <a name="building-module-manager-for-cortex-r4-using-ac6"></a>Compilación de administrador de módulos para Cortex-R4 con AC6

Ejemplo sencillo de línea de comandos para compilar un administrador de módulos de Cortex-R4 con AC6:
...
#### <a name="module-preamble-for-cortex-r4-using-iar"></a>Preámbulo de módulo para Cortex-R4 con IAR
...
#### <a name="module-properties-for-cortex-r4-using-iar"></a>Propiedades de módulo para Cortex-R4 con IAR
...
#### <a name="building-modules-for-cortex-r4-using-iar"></a>Compilación de módulos para Cortex-R4 con IAR

Se proporciona un área de trabajo de ejemplo. Compile la biblioteca de ThreadX, la biblioteca de ThreadX Modules, el proyecto de módulo de demostración y el proyecto de administrador de módulos de demostración.

#### <a name="thread-extension-definition-for-cortex-r4-using-iar"></a>Definición de extensión de subproceso para Cortex-R4 con IAR
...
#### <a name="building-module-manager-for-cortex-r4-using-iar"></a>Compilación de administrador de módulos para Cortex-R4 con IAR
...
## <a name="mcf544xx-processor"></a>Procesador MCF544xx

### <a name="mcf544xx-using-ghs"></a>MCF544xx con GHS

#### <a name="module-preamble-for-mcf544xx-using-ghs"></a>Preámbulo de módulo para MCF544xx con GHS
...
#### <a name="module-properties-for-mcf544xx-using-ghs"></a>Propiedades de módulo para MCF544xx con GHS
...
#### <a name="building-modules-for-mcf544xx-using-ghs"></a>Compilación de módulos para MCF544xx con GHS

Se proporciona un área de trabajo de ejemplo. Compile la biblioteca de ThreadX, la biblioteca de ThreadX Modules, el proyecto de módulo de demostración y el proyecto de administrador de módulos de demostración.

#### <a name="thread-extension-definition-for-mcf544xx-using-ghs"></a>Definición de extensión de subproceso para MCF544xx con GHS
...
#### <a name="building-module-manager-for-mcf544xx-using-ghs"></a>Compilación de administrador de módulos para MCF544xx con GHS

Se proporciona un área de trabajo de ejemplo. Compile la biblioteca de ThreadX, la biblioteca de ThreadX Modules, el proyecto de módulo de demostración y el proyecto de administrador de módulos de demostración.

#### <a name="attributes-for-external-memory-enable-api-for-mcf544xx-using-ghs"></a>Atributos de API de habilitación de memoria externa para MCF544xx con GHS

Esta característica no está habilitada en MCF544xx.

## <a name="rx63-processor"></a>Procesador RX63

### <a name="rx63-using-iar"></a>RX63 con IAR

#### <a name="module-preamble-for-rx63-using-iar"></a>Preámbulo de módulo para RX63 con IAR
...
#### <a name="module-properties-for-rx63-using-iar"></a>Propiedades de módulo para RX63 con IAR
...
#### <a name="building-modules-for-rx63-using-iar"></a>Compilación de módulos para RX63 con IAR

Se proporciona un área de trabajo de ejemplo. Compile la biblioteca de ThreadX, la biblioteca de ThreadX Modules, el proyecto de módulo de demostración y el proyecto de administrador de módulos de demostración.

#### <a name="thread-extension-definition-for-rxrx635n-using-iar"></a>Definición de extensión de subproceso para RXRX635N con IAR
...
#### <a name="building-module-manager-for-rx63-using-iar"></a>Compilación de administrador de módulos para RX63 con IAR

Se proporciona un área de trabajo de ejemplo. Compile la biblioteca de ThreadX, la biblioteca de ThreadX Modules, el proyecto de módulo de demostración y el proyecto de administrador de módulos de demostración.

#### <a name="attributes-for-external-memory-enable-api-for-rx63-using-iar"></a>Atributos de API de habilitación de memoria externa para RX63 con IAR

| Parámetro del atributo | Significado |
|---|---|
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_EXECUTE | Ejecutar código |
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_WRITE | Acceso de escritura |
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_READ | acceso de lectura |

## <a name="rx65n-processor"></a>Procesador RX65N

### <a name="rx65n-using-iar"></a>RX65N con IAR

#### <a name="module-preamble-for-rx65n-using-iar"></a>Preámbulo de módulo para RX65N con IAR
...
#### <a name="module-properties-for-rx65n-using-iar"></a>Propiedades de módulo para RX65N con IAR
...
#### <a name="building-modules-for-rx65n-using-iar"></a>Compilación de módulos para RX65N con IAR

Se proporciona un área de trabajo de ejemplo. Compile la biblioteca de ThreadX, la biblioteca de ThreadX Modules, el proyecto de módulo de demostración y el proyecto de administrador de módulos de demostración.

#### <a name="thread-extension-definition-for-rx65n-using-iar"></a>Definición de extensión de subproceso para RX65N con IAR
...
#### <a name="building-module-manager-for-rx65n-using-iar"></a>Compilación de administrador de módulos para RX65N con IAR

Se proporciona un área de trabajo de ejemplo. Compile la biblioteca de ThreadX, la biblioteca de ThreadX Modules, el proyecto de módulo de demostración y el proyecto de administrador de módulos de demostración.

#### <a name="attributes-for-external-memory-enable-api-for-rx65n-using-iar"></a>Atributos de API de habilitación de memoria externa para RX65N con IAR
