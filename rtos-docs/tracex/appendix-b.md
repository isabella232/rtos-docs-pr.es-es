---
title: 'Apéndice B: El archivo tx_trace.h'
description: En este capítulo se muestra el archivo tx_trace.h.
author: philmea
ms.service: rtos
ms.topic: article
ms.date: 5/19/2020
...
ms.locfileid: "104815938"
---
# <a name="appendix-b---the-tx_traceh-file"></a><span data-ttu-id="81f0d-103">Apéndice B: El archivo tx_trace.h</span><span class="sxs-lookup"><span data-stu-id="81f0d-103">Appendix B - The tx_trace.h file</span></span>

<span data-ttu-id="81f0d-104">En este capítulo se muestra el archivo **tx_trace.h**.</span><span class="sxs-lookup"><span data-stu-id="81f0d-104">This chapter displays the **tx_trace.h** file.</span></span>
