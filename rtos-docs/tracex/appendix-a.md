---
title: 'Apéndice A: tx_port.h de ejemplo'
description: En este capítulo se muestra un archivo tx_port.h de ejemplo.
author: philmea
ms.service: rtos
ms.topic: article
ms.date: 5/19/2020
...
ms.locfileid: "104815953"
---
# <a name="appendix-a---sample-tx_porth"></a><span data-ttu-id="361f5-103">Apéndice A: tx_port.h de ejemplo</span><span class="sxs-lookup"><span data-stu-id="361f5-103">Appendix A - Sample tx_port.h</span></span>

<span data-ttu-id="361f5-104">En este capítulo se muestra un archivo **tx_port.h** de ejemplo.</span><span class="sxs-lookup"><span data-stu-id="361f5-104">This chapter displays a sample **tx_port.h** file.</span></span>
