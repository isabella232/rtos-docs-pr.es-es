---
title: 'Capítulo 3: Servicios BSD de Azure RTOS NetX Duo'
description: Este capítulo contiene una descripción de todos los servicios básicos BSD de Azure RTOS NetX Duo (enumerados a continuación) en orden alfabético.
author: philmea
ms.author: philmea
ms.date: 06/04/2020
ms.topic: article
...
ms.locfileid: "104814821"
---
# <a name="chapter-3---azure-rtos-netx-duo-bsd-services"></a><span data-ttu-id="50208-103">Capítulo 3: Servicios BSD de Azure RTOS NetX Duo</span><span class="sxs-lookup"><span data-stu-id="50208-103">Chapter 3 - Azure RTOS NetX Duo BSD Services</span></span>

<span data-ttu-id="50208-104">Este capítulo contiene una descripción de todos los servicios básicos BSD de Azure RTOS NetX Duo (enumerados a continuación) en orden alfabético.</span><span class="sxs-lookup"><span data-stu-id="50208-104">This chapter contains a description of all Azure RTOS NetX Duo BSD basic services (listed below) in alphabetic order.</span></span>
