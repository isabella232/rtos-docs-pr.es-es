---
title: 'Apéndice A: Servicios de Azure RTOS NetX Duo'
description: Obtenga información sobre los servicios de Azure RTOS NetX Duo.
author: philmea
ms.author: philmea
ms.date: 05/19/2020
ms.topic: article
...
ms.locfileid: "104815418"
---
# <a name="appendix-a---azure-rtos-netx-duo-services"></a><span data-ttu-id="aec6d-103">Apéndice A: Servicios de Azure RTOS NetX Duo</span><span class="sxs-lookup"><span data-stu-id="aec6d-103">Appendix A - Azure RTOS NetX Duo Services</span></span>

## <a name="address-resolution-protocol-arp"></a><span data-ttu-id="aec6d-104">Protocolo de resolución de direcciones (ARP)</span><span class="sxs-lookup"><span data-stu-id="aec6d-104">Address Resolution Protocol (ARP)</span></span>  
...
## <a name="internet-control-message-protocol-icmp"></a><span data-ttu-id="aec6d-105">Protocolo de mensajes de control de Internet (ICMP)</span><span class="sxs-lookup"><span data-stu-id="aec6d-105">Internet Control Message Protocol (ICMP)</span></span>  
...
## <a name="internet-group-management-protocol-igmp"></a><span data-ttu-id="aec6d-106">Protocolo de administración de grupos de Internet (IGMP)</span><span class="sxs-lookup"><span data-stu-id="aec6d-106">Internet Group Management Protocol (IGMP)</span></span>  
...
UINT     nx_igmp_multicast_leave(NX_IP *ip_ptr,
            ULONG group_address);
```
## <a name="internet-protocol-ip"></a><span data-ttu-id="aec6d-107">Protocolo de Internet (IP)</span><span class="sxs-lookup"><span data-stu-id="aec6d-107">Internet Protocol (IP)</span></span> 
...
## <a name="neighbor-discovery"></a><span data-ttu-id="aec6d-108">Detección de equipos cercanos</span><span class="sxs-lookup"><span data-stu-id="aec6d-108">Neighbor Discovery</span></span>  
...
## <a name="packet-management"></a><span data-ttu-id="aec6d-109">Administración de paquetes</span><span class="sxs-lookup"><span data-stu-id="aec6d-109">Packet Management</span></span>  
...
## <a name="reverse-address-resolution-protocol-rarp"></a><span data-ttu-id="aec6d-110">Protocolo de resolución de direcciones inversa (RARP)</span><span class="sxs-lookup"><span data-stu-id="aec6d-110">Reverse Address Resolution Protocol (RARP)</span></span>  
...
## <a name="system-management"></a><span data-ttu-id="aec6d-111">Administración del sistema</span><span class="sxs-lookup"><span data-stu-id="aec6d-111">System Management</span></span>  

```c
VOID     nx_system_initialize(VOID);
```

## <a name="transmission-control-protocol-tcp"></a><span data-ttu-id="aec6d-112">Protocolo de control de transmisión (TCP)</span><span class="sxs-lookup"><span data-stu-id="aec6d-112">Transmission Control Protocol (TCP)</span></span>  
...
## <a name="user-datagram-protocol-udp"></a><span data-ttu-id="aec6d-113">Protocolo de datagramas de usuario (UDP)</span><span class="sxs-lookup"><span data-stu-id="aec6d-113">User Datagram Protocol (UDP)</span></span>  
