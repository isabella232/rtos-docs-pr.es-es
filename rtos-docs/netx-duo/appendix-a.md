...
ms.locfileid: "116790146"
---
# <a name="appendix-a---azure-rtos-netx-duo-services"></a>Apéndice A: Servicios de Azure RTOS NetX Duo

## <a name="address-resolution-protocol-arp"></a>Protocolo de resolución de direcciones (ARP)  
...
UINT     nx_igmp_multicast_leave(NX_IP *ip_ptr,
            ULONG group_address);
```
## <a name="internet-protocol-ip"></a>Protocolo de Internet (IP) 
...
## <a name="packet-management"></a>Administración de paquetes  
...
## <a name="reverse-address-resolution-protocol-rarp"></a>Protocolo de resolución de direcciones inversa (RARP)  
