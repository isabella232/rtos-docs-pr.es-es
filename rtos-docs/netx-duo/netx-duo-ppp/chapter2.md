...
El paquete del Protocolo punto a punto (PPP) de Azure RTOS NetX Duo está disponible en <https://github.com/azure-rtos/netxduo>. El paquete incluye los siguientes archivos:
...
- **NX_PPP_DNS_OPTION_DISABLE** Si está definida, la opción servidor DNS principal está deshabilitada en la respuesta de IPCP. De manera predeterminada, esta opción no está definida.
