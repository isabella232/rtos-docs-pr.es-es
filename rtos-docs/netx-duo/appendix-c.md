...
ms.locfileid: "116789772"
---
# <a name="appendix-c---azure-rtos-snetx-duo-data-types"></a>Apéndice C: Tipos de datos de Azure RTOS NetX Duo
...
```
## <a name="nx_ipv6_default_router_entry"></a>NX_IPV6_DEFAULT_ROUTER_ENTRY
...
#endif /* FEATURE_NX_IPV6 */
```
## <a name="nx_ipv6_prefix_entry"></a>NX_IPV6_PREFIX_ENTRY
...
```
## <a name="nxd_ipv6_address"></a>NXD_IPV6_ADDRESS
...
```
## <a name="nxd_address"></a>NXD_ADDRESS
