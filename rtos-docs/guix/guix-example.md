...
ms.locfileid: "116786406"
---
# <a name="guix-example"></a>Ejemplo de GUIX

El sistema de demostración de GUIX se entrega con un pequeño ejemplo, que se define en examples/HelloWorld/HelloWorld.c. En este ejemplo se muestran los pasos necesarios para inicializar el sistema GUIX para configurar los controladores de pantalla. El código fuente se muestra en las páginas siguientes.
