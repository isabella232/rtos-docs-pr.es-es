...
En esta clase se definen 3 puntos de conexión, 2 en masa para enviar y recibir datos y uno para interrumpir los eventos.
...
A continuación, se deben rellenar los descriptores de trabajos de impresión como se indica a continuación:
...
Esta clase es la capa de PTP genérica que se encuentra entre la pila de host USB y la capa PictBridge.
...
La función de host de PictBridge requiere una devolución de llamada cuando los datos están listos para imprimirse. Esto se logra pasando un puntero de función en la estructura de host de PictBridge como se indica a continuación.
...
- **UX_ERROR**: (0x01): la aplicación no ha podido imprimir los datos.
