...
ms.locfileid: "116801857"
---
# <a name="appendix-b---azure-rtos-threadx-constants"></a>Apéndice B: constantes de Azure RTOS ThreadX

- [**Listas alfabéticas**](#alphabetic-listings) 
- [**Enumerar por valor**](#listing-by-value)

## <a name="alphabetic-listings"></a>Listas alfabéticas

| Constante (por orden alfabético) | Value |
| --------- | - |
| TX_1_ULONG | 1 |
| TX_2_ULONG | 2 |
| TX_4_ULONG | 4 |
...
## <a name="listing-by-value"></a>Enumerar por valor

| Constante (por valor) | Value  |
| ------------- | - |
| TX_DONT_START | 0 |
| TX_FALSE | 0 |
| TX_NO_ACTIVATE | 0 |
