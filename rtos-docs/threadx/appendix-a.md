...
ms.locfileid: "116788531"
---
# <a name="appendix-a---azure-rtos-threadx-api-services"></a>Apéndice A: servicios de API de Azure RTOS ThreadX

## <a name="entry-function"></a>Función de entrada

```c
VOID      tx_kernel_enter(VOID);
```

## <a name="block-memory-services"></a>Servicios de memoria de bloques
...
## <a name="byte-memory-services"></a>Servicios de memoria de bytes
...
## <a name="thread-control-services"></a>Servicios de control de subprocesos
...
## <a name="time-services"></a>Servicios de hora
...
## <a name="timer-services"></a>Servicios de temporizador
