---
title: 'Apéndice A: servicios de API de Azure RTOS ThreadX'
description: Explore los servicios de API de Azure RTOS ThreadX.
author: philmea
ms.author: philmea
ms.date: 05/19/2020
ms.topic: article
...
ms.locfileid: "104814369"
---
# <a name="appendix-a---azure-rtos-threadx-api-services"></a><span data-ttu-id="5c394-103">Apéndice A: servicios de API de Azure RTOS ThreadX</span><span class="sxs-lookup"><span data-stu-id="5c394-103">Appendix A - Azure RTOS ThreadX API Services</span></span>

## <a name="entry-function"></a><span data-ttu-id="5c394-104">Función de entrada</span><span class="sxs-lookup"><span data-stu-id="5c394-104">Entry Function</span></span>

```c
VOID      tx_kernel_enter(VOID);
```

## <a name="block-memory-services"></a><span data-ttu-id="5c394-105">Servicios de memoria de bloques</span><span class="sxs-lookup"><span data-stu-id="5c394-105">Block Memory Services</span></span>
...
## <a name="byte-memory-services"></a><span data-ttu-id="5c394-106">Servicios de memoria de bytes</span><span class="sxs-lookup"><span data-stu-id="5c394-106">Byte Memory Services</span></span>
...
## <a name="event-flags-services"></a><span data-ttu-id="5c394-107">Servicios de marcas de eventos</span><span class="sxs-lookup"><span data-stu-id="5c394-107">Event Flags Services</span></span>
...
## <a name="interrupt-control"></a><span data-ttu-id="5c394-108">Control de interrupción</span><span class="sxs-lookup"><span data-stu-id="5c394-108">Interrupt Control</span></span>

```c
UINT      tx_interrupt_control(UINT new_posture);
```

## <a name="mutex-services"></a><span data-ttu-id="5c394-109">Servicios de Mutex</span><span class="sxs-lookup"><span data-stu-id="5c394-109">Mutex Services</span></span>
...
```
## <a name="queue-services"></a><span data-ttu-id="5c394-110">Servicios de colas</span><span class="sxs-lookup"><span data-stu-id="5c394-110">Queue Services</span></span>
...
## <a name="semaphore-services"></a><span data-ttu-id="5c394-111">Servicios de semáforos</span><span class="sxs-lookup"><span data-stu-id="5c394-111">Semaphore Services</span></span>
...
## <a name="thread-control-services"></a><span data-ttu-id="5c394-112">Servicios de control de subprocesos</span><span class="sxs-lookup"><span data-stu-id="5c394-112">Thread Control Services</span></span>
...
## <a name="time-services"></a><span data-ttu-id="5c394-113">Servicios de hora</span><span class="sxs-lookup"><span data-stu-id="5c394-113">Time Services</span></span>
...
## <a name="timer-services"></a><span data-ttu-id="5c394-114">Servicios de temporizador</span><span class="sxs-lookup"><span data-stu-id="5c394-114">Timer Services</span></span>
