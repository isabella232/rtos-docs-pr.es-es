...
ms.locfileid: "116801824"
---
# <a name="appendix-c---azure-rtos-threadx-data-types"></a>Apéndice C: tipos de datos de Azure RTOS ThreadX
...
## <a name="tx_byte_pool"></a>TX_BYTE_POOL
...
```
## <a name="tx_event_flags_group"></a>TX_EVENT_FLAGS_GROUP
```c
...
```
## <a name="tx_semaphore"></a>TX_SEMAPHORE
...
```
## <a name="tx_timer_internal"></a>TX_TIMER_INTERNAL
